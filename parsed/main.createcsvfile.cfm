...
<!--- circuit: main --->
<!--- fuseaction: createCSVFile --->
<cftry>
<cfset myFusebox.thisPhase = "requestedFuseaction">
<cfset myFusebox.thisCircuit = "main">
<cfset myFusebox.thisFuseaction = "createCSVFile">
<cfset fileDelete = application.fileActions.deleteFile('1.csv') >
<cfset content = application.createCsv.create() >
<cfset application.fileActions.writeFile('1.csv',content) >
<!--- do action="main.menu" --->
