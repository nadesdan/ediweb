...
<cfset myFusebox.thisFuseaction = "export">
<cfset invContent = application.ediFlat.invoice() >
<cfset application.fileActions.writeFile('inv.flt',invContent) >
<cfset cnclContent = application.ediFlat.cancel() >
<cfset application.fileActions.writeFile('cncl.flt',cnclContent) >
<!--- do action="main.menu" --->
