...
<cfset myFusebox.thisFuseaction = "dump">
<cfsavecontent variable="pageContent">
<cftry>
<cfoutput><cfinclude template="../views/dsp_dump.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 12 and right(cfcatch.MissingFileName,12) is "dsp_dump.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse dsp_dump.cfm in circuit v which does not exist (from fuseaction v.dump).">
